...
/*
 * Mobile Weekend Schedule — a one-day-at-a-time pager (thumb-friendly), the
 * phone counterpart to the desktop all-days agenda (WeekendBody). Vintage
 * palette + sticky bottom nav so it stays inside the site set.
 */
